					...
					<div class="span4">
						...
						<div class="well home-text-box">
							...
							<p class="read-text-box">The inaugural Career Fair,
								organized by the University of Colombo School of Computing aims
								to strengthen the ties between the academic and the corporate
								worlds. It provides an opportunity for leading firms to recruit
								the best IT talent the UCSC has to offer in an organized, highly
					...
					<div class="span4">
						...
						<div class="well home-text-box">
							...
							<p class="read-text-box">The main objective of the UCSC is
								to provide high quality undergraduate degree programs to
								students in the fields of Computer Science and Information and
							...
							<p>
								<a class="btn btn-primary" href="http://www.ucsc.lk" target="_blank">Visit
									Website &raquo;</a>
							</p>
						</div>
					</div>
					...
					<div class="span4">
						...
						<div class="well home-text-box">
							...
							<p class="read-text-box">The talent available at the Career Fair focuses their efforts							
								on research and innovation. The students are the best in their
								respective streams and have been chosen for their academic
								prowess. The quality of their work is unparalled and would be a
								major asset to any organisation willing to hire them.</p>
							<p>
								<a class="btn btn-primary" href="<?php echo HTTP_BASE . '/students'; ?>">View Students &raquo;</a>
							</p>
						</div>
					</div>
					<!-- /.span4 -->
