...
defined('DB_NAME') ? null : define("DB_NAME", "careers.ucsc.lk");
...
defined('WEB_APP_NAME') ? null : define("WEB_APP_NAME", "UCSC Career Fair 2013");
defined('WEB_APP_SHORT_NAME') ? null : define("WEB_APP_SHORT_NAME", "Career Fair '13");
